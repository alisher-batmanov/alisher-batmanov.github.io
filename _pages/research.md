...
- <span style="color:#000"><strong><a href="https://docs.iza.org/dp16912.pdf" target="_blank" style="color:#000; text-decoration: none;">"Mass Reproducibility and Replicability: A New Hope"</a></strong></span> (meta paper with Abel Brodeur, Derek Mikola, Nikolai Cook, et al.) (<span class="abstract-toggle" onclick="var el=document.getElementById('replicability-abstract'); el.style.display = el.style.display==='none' ? 'block' : 'none';">Abstract</span>)
