...
- <span style="color:#001f3d"><strong>“Mental Models, Social Learning and Statistical Discrimination: A Laboratory Study”</strong></span>  
  ...
  <span id="mental-models-toggle" style="cursor: pointer; text-decoration: underline;" onclick="showAbstract('mental-models-abstract', 'mental-models-toggle')"><strong>(Abstract)</strong></span>
...
- <span style="color:#001f3d"><strong>“Stigma, Beliefs and Demand for Mental Health Services Among University Students”</strong></span>  
  ...
  <span id="mental-health-toggle" style="cursor: pointer; text-decoration: underline;" onclick="showAbstract('mental-health-abstract', 'mental-health-toggle')"><strong>(Abstract)</strong></span>
...
- <strong>"Mass Reproducibility and Replicability: A New Hope" (2024)</strong>  
  ...
  Replicate results of 110 papers: / computational reproducibility 85% and / robustness reproducibility 70  
  <span id="replicability-toggle" style="cursor: pointer; text-decoration: underline;" onclick="showAbstract('replicability-abstract', 'replicability-toggle')"><strong>(Abstract)</strong></span>
...
<script>
function showAbstract(abstractId, toggleId) {
